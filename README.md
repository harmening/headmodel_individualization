...
* Save surface meshes as .tri (for [OpenMEEG](https://openmeeg.github.io/)) and as 
.mat for [Matlab](https://de.mathworks.com/products/matlab.html)/[FieldTrip](https://www.fieldtriptoolbox.org/) or any other mesh format like .stl, .obj, .ply, ....
