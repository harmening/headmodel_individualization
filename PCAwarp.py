...
if __name__ == '__main__':
    ...
    if scalp.endswith('.npy'):
        ...
        np.savetxt(pth(os.path.dirname(scalp), 'captrak_electrodes.txt'), scalp_proxies, delimiter='\t')
    ...
    np.savetxt(pth(os.path.dirname(scalp), 'captrak_electrodes_ctf.txt'), scalp_proxies, delimiter='\t')
